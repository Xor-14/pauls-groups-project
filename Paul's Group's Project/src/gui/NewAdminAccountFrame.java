 ...
 * @author xor
 */
public class NewAdminAccountFrame extends javax.swing.JFrame {
   ...
   private void imageSlideshow() {
    ...
    private void initComponents() {
        ...
        Title.setText("<html>Create a Seller's Account</html>");
        ...
        adminEmailField.setFont(new java.awt.Font("New Peninim MT", 0, 18)); // NOI18N
        adminEmailField.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        adminEmailField.setText("email@test.com");
        adminEmailField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                adminEmailFieldActionPerformed(evt);
            }
        });
        LoginForm.add(adminEmailField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, 320, 40));

        Password.setFont(new java.awt.Font("New Peninim MT", 0, 15)); // NOI18N
        Password.setForeground(new java.awt.Color(255, 255, 255));
        Password.setText("Password");
        LoginForm.add(Password, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 290, -1, -1));
        ...
        LoginForm.add(userPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 305, 320, 40));
        ...
        LoginForm.add(login, new org.netbeans.lib.awtextra.AbsoluteConstraints(55, 355, 300, 40));
        ...
        LoginForm.add(shiftForms, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 407, 80, 20));
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        ...
        if (success) {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "Admin Registration Successful");
            this.dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewAdminAccountFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewAdminAccountFrame().setVisible(true);
            }
        });
    }
